...
This script performs a series of checks on the system and then launches a FastAPI Spark1 server.
...
Exit codes:
  ...
  7 = FastAPI Spark1 dependencies check failed
  8 = Database connection failed
"""
print("SPARK1_APP: Script starting...")
