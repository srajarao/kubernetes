...
CLUSTER_NODES="tower,nano,agx,spark1,spark2"
...
# NVIDIA Spark1 Configuration
SPARK1_IP="10.1.10.201"
SPARK1_ARCH="arm64"
SPARK1_COMPONENTS="python,cuda,tensorrt,pytorch,tensorflow,fastapi,gpu-monitoring,llm,rag"  # Components to install
SPARK1_BASE_IMAGE="l4t-minimal"  # Base image key from image-matrix.sh
SPARK1_IMAGE_NAME="fastapi_spark1"
SPARK1_IMAGE_TAG="latest"
SPARK1_DOCKERFILE="agent/spark1/dockerfile.spark1.req"  # Will be auto-generated
SPARK1_REQUIREMENTS="agent/spark1/requirements.spark1.txt"  # Will be auto-generated

# NVIDIA Spark2 Configuration
SPARK2_IP="10.1.10.202"
SPARK2_ARCH="arm64"
SPARK2_COMPONENTS="python,cuda,tensorrt,pytorch,tensorflow,fastapi,gpu-monitoring,llm,rag"  # Components to install
SPARK2_BASE_IMAGE="l4t-minimal"  # Base image key from image-matrix.sh
SPARK2_IMAGE_NAME="fastapi_spark2"
SPARK2_IMAGE_TAG="latest"
SPARK2_DOCKERFILE="agent/spark2/dockerfile.spark2.req"  # Will be auto-generated
SPARK2_REQUIREMENTS="agent/spark2/requirements.spark2.txt"  # Will be auto-generated
