...
EOF
    ...
    # Set proper permissions on nano and agx config directories
    #chmod -R 777 "$NANO_CONFIG_DIR" 2>/dev/null
   # print_result $? "  Set proper permissions on nano agent config directory: $NANO_CONFIG_DIR"
    #chmod -R 777 "$AGX_CONFIG_DIR" 2>/dev/null
