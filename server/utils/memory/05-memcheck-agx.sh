...
# =============================================================================
# Memory Check and Cleanup Script for AGX
# =============================================================================
# This script performs comprehensive memory analysis and cleanup on AGX node
...
SSH_USER="sanjay"
LOG_FILE="/home/sanjay/containers/kubernetes/memcheck_agx_$(date +%Y%m%d_%H%M%S).log"
...
# Header
echo "==================================================================================" | tee "$LOG_FILE"
echo "🔍 AGX MEMORY CHECK AND CLEANUP SCRIPT" | tee -a "$LOG_FILE"
echo "==================================================================================" | tee -a "$LOG_FILE"
