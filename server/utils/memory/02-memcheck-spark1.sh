...
# =============================================================================
# Memory Check and Cleanup Script for Spark1
# =============================================================================
# This script performs comprehensive memory analysis and cleanup on Spark1 node
...
SSH_USER="sanjay"
LOG_FILE="/home/sanjay/containers/kubernetes/memcheck_spark1_$(date +%Y%m%d_%H%M%S).log"
...
# Header
echo "==================================================================================" | tee "$LOG_FILE"
echo "🔍 SPARK1 MEMORY CHECK AND CLEANUP SCRIPT" | tee -a "$LOG_FILE"
echo "==================================================================================" | tee -a "$LOG_FILE"
