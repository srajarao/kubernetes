...
# =============================================================================
# Remove K3s Agent from Spark2 Node
# =============================================================================
# This script removes the K3s agent service from the Spark2 node
...
SSH_USER="sanjay"
LOG_FILE="/home/sanjay/containers/kubernetes/rmvagent_spark2_$(date +%Y%m%d_%H%M%S).log"
...
# Header
echo "==================================================================================" | tee "$LOG_FILE"
echo "🗑️  REMOVE K3S AGENT FROM SPARK2" | tee -a "$LOG_FILE"
echo "==================================================================================" | tee -a "$LOG_FILE"
...
log "Stopping k3s-agent service on Spark2..."
...
log "Disabling k3s-agent service on Spark2..."
...
log "Running k3s-agent-uninstall.sh on Spark2..."
...
echo "==================================================================================" | tee -a "$LOG_FILE"
echo "Spark2 node has been removed from the Kubernetes cluster." | tee -a "$LOG_FILE"
echo "Log file: $LOG_FILE" | tee -a "$LOG_FILE"
echo "==================================================================================" | tee -a "$LOG_FILE"

echo -e "${GREEN}🎉 K3s agent removal from Spark2 completed successfully!${NC}"